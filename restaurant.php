...
<?php
  ...
  $sql="SELECT * FROM restaurant WHERE restaurant_Id LIKE '%".substr(base64_decode(str_replace(" ","+",$_GET['restaurant_Id'])), 1)."%'";

  $restaurant=sqldatabaselink($link,$sql);
        ...
        <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
             ...
             if($row['Picture1']&& $row['Picture2']){
               echo'<div class="carousel-item active"><img src="'.$row['Picture1'].'"  class="d-block w-100" style="height:30vw"><div class="carousel-caption d-none d-md-block" onerror="this.src='.'img/bg1.png'.'"><h5>'.$row['Picdescribe1'].'</h5></div></div>';
              }
              if($row['Picture2']){
                echo'<div class="carousel-item "><img src="'.$row['Picture2'].'"  class="d-block w-100" style="height:30vw"><div class="carousel-caption d-none d-md-block" onerror="this.src='.'img/bg1.png'.'"><h5>'.$row['Picdescribe2'].'</h5></div></div>';
              }
              if($row['Picture3']){
                echo'<div class="carousel-item "><img src="'.$row['Picture3'].'"  class="d-block w-100" style="height:30vw"><div class="carousel-caption d-none d-md-block" onerror="this.src='.'img/bg1.png'.'"><h5>'.$row['Picdescribe3'].'</h5></div></div>';
              }
             ?>
...
<?php
    ...
    $scenic_spot=sqldatabaselink($link,$sql);
