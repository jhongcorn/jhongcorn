...
<script>
	...
	$(function(){
		...
		$("#re_"+id_str+"password").bind("click",function(){	
...
<?php require "forget_password.php";?>
			    	...
			    	<div class="tab-pane fade in show active" id="panel7" role="tabpanel">
				        ...
				        <div class="modal-body mb-1">
							...
							<div class="d-flex align-items-center justify-content-center">
								<a class="btn btn-outline-info" onclick="window.location='<?php echo $fbloginURL;?>'"><i class="fab fa-facebook-f fa-2x"></i><span class="OAuth_span">以Facebook帳號登入</span></a>
								<a class="btn btn-outline-info" onclick="window.location='<?php echo $loginURL;?>'"><i class="fab fa-google fa-2x"></i><span class="OAuth_span">以Google帳號登入</span></a>
							</div>
				        </div>
				        <!--Footer-->
