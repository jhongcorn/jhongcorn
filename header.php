<script>
        ...
        if($("#Search_text").val()!=""){
          $.ajax({
            ...
            success:function(data){
              ...
              console.log(data);
              var searchhtml='<div class="modal-header font-weight-bold col-12">店面:<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>';
              ...
              searchhtml+='<div class="modal-header font-weight-bold col-12">旅館:<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>';
              ...
              searchhtml+='<div class="modal-header font-weight-bold col-12">景點:<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>';
  ...
  function navbarbody(){
    ...
    if($('#navbarNav').css('display')=='none'){
      ...
      $('.navbar').css('z-index','1060');
      $('footer').css('z-index','1060');
    }else{
...
<nav class="navbar navbar-expand-lg navbar-light bg-ligh my-3 sticky-top d-flex border border-info bg-info">
  <a class="navbar-brand" href="index.php"><img src="img/logo.png" class='d-inline-block align-top' width="40" height="40"><span class="h6">JhongCorn</span></a>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    ...
    <ul class="navbar-nav ">
      <li class="nav-item <?php echo isset($_GET['hotel_ch'])?'active bg-primary':'';?>">
        <a class="nav-link d-flex " href="index.php?hotel_ch=<?php echo base64_encode('hotel_ch');?>">旅館<i class="fas fa-home ml-auto head-block"></i></a>
      </li>
      <li class="nav-item  <?php echo isset($_GET['scenic_spot'])?'active bg-primary':'';?>">
        <a class="nav-link d-flex" href="index.php?scenic_spot=<?php echo base64_encode('scenic_spot');?>">景點<i class="fas fa-home ml-auto head-block"></i></a>
      </li>
      <li class="nav-item <?php echo isset($_GET['restaurant'])?'active bg-primary':'';?>">
        <a class="nav-link d-flex" href="index.php?restaurant=<?php echo base64_encode('restaurant');?>">店家<i class="fas fa-home ml-auto head-block"></i></a>
      </li>
    </ul> 
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item"><div id="google_translate_element" class="nav-link" ></div></li>
    </ul>  
</nav>
...
<div class="input-group md-form form-sm form-2 pl-0">
  ...
  <input class="form-control my-0 py-1 border-info" id="Search_text" type="text" placeholder="Search" aria-label="Search">
</div>
...
<div class="modal fade" id="searchform_menu" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <button type="button" class="btn btn-outline-info waves-effect ml-auto mr-auto" data-dismiss="modal">Close</button>
    </div>
  </div>
</div>
